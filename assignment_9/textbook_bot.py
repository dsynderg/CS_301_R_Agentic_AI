...
DEFAULT_SYSTEM_PROMPT = (
    "You are a helpful assistant answering questions about textbook content. "
...
def main():
    ...
    persist_dir = os.environ.get("TEXTBOOK_CHROMA_DIR", "./textbook_chroma")
    ...
    try:
        ...
        print(f"Error: Could not find 'textbook_paragraphs' collection. Make sure to embed textbook content first.")
        print(f"Details: {e}")
        return
    
    # Get user question
    print("\n" + "="*60)
    print("Textbook Q&A Bot")
    print("="*60)
    question = input("\nAsk a question about the textbook: ").strip()
    ...
    # Build context
    context = "Here are relevant excerpts from textbook content:\n\n"
